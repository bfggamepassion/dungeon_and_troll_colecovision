...
// Les sprites des armes seront stockés en non compressé, car j'ai plus de 64 patterns
// de sprites je vais donc devoir les modifier "à la volée", ou plutôt à la sélection
// du joueur
